 ...
 */
abstract contract Option is ERC1155, ERC1155Supply, ERC1155Burnable, AccessControl {
    ...
    /// @dev use EnumerableSet instead of array as we need to check if the token id is valid upon minting new option tokens
     ...
     * @param expiryPrices_ the void options with the expiry prices
     */
    ...
    /**
     * @notice call this function to void options that met that expiry price condition
     ...
     * if the id is zero, it means the option token does not exist
     ...
     * true: valid. can be exercised or traded
     * false: option token does not exist or has been avoided
     * @param tokenId_ the option token id
     */
     ...
     * @param expiryPrice_ the expiry price
     */
     ...
     * @dev Note there are no guarantees on the ordering of values inside the array
     ...
     * @param expiryPrice_ the expiry price to void options
     */
